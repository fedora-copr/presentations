...
An RPM Packaging Workshop

<p style="font-size:0.7em; color:rgba(255,255,255,0.9);">Pavel Raiskup · Jiří Kyjovský · Miroslav Suchý</p>
<p style="font-size:0.55em; color:rgba(255,255,255,0.6);">Slides originally created by Tom "spot" Callaway</p>

Note:

- introduce yourselves
- workshop: hands-on RPM packaging from scratch
